    ...
    fun createOneShotBond(
        ...
        val transaction =
            mapOf(
                ...
                TransactionRepository.KEY_BOND_EXPIRY to (System.currentTimeMillis() + expiryBlocks * 60_000),
                TransactionRepository.KEY_BALANCE to (transactionRepository.getMyBalance() - amount)
            )
